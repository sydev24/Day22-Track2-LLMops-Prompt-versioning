...
PROMPT_V1_NAME = "antigravity-rag-prompt-v1"
PROMPT_V2_NAME = "antigravity-rag-prompt-v2"
...
def main():
    ...
    print(f"\n📊 Routing: V1={v1_count} câu | V2={v2_count} câu | Tổng={len(subset)}")
